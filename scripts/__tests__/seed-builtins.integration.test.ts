...
//
// Post-skills-rewrite: the manifest / `getIngestionFilingSkill`
// assertions that used to live here have been dropped — skills now
// surface through the agent's system prompt via progressive
// disclosure (see `src/lib/skills/README.md`).
...
describe('seedBuiltins (integration)', () => {
  it('inserts the ingestion-filing skill + default scaffolding', async () => {
    ...
    // Frontmatter landed with the content.
