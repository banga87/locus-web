...
// and will take over the folder/document-level breakdown.
//
...
export type ResolvedResource =
  ...
  | { type: 'folder'; brainId: string; folderId: string }
  | { type: 'document'; brainId: string; folderId: string; documentId: string };
 ...
 *
 * TODO: Phase 1 — pull folder/document ids from tool inputs via
